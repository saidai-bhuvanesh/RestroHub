  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div
          className={`flex items-center justify-between transition-all duration-300 ${scrolled ? "h-16" : "h-24"}`}
        >
          {/* Brand */}
          <a href="#" className="flex items-center gap-2.5 group">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-electric-cyan via-electric-purple to-electric-pink shadow-[0_0_20px_rgba(236,72,153,0.4)] group-hover:shadow-[0_0_35px_rgba(6,182,212,0.6)] transition-all animate-aurora bg-[length:200%_200%]">
              <UtensilsCrossed className="h-5 w-5 text-white" />
            </div>
            <span className="text-xl font-extrabold tracking-tight text-slate-900 dark:text-white">
              Restro
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-electric-cyan to-electric-pink animate-aurora bg-[length:200%_200%]">
                ly
              </span>
            </span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-8">
            <div className="flex items-center gap-6 rounded-full bg-slate-100/50 dark:bg-white/5 px-6 py-2 backdrop-blur-md border border-slate-200/50 dark:border-white/10 shadow-[0_0_15px_rgba(255,255,255,0.05)]">
              {navLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  ...
                  className={`text-sm font-medium transition-all hover:text-electric-blue dark:hover:text-cyber-blue ${
                    activeLink === link.href
                      ? "text-electric-blue dark:text-cyber-blue drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]"
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link
              to="/login"
              className="text-sm font-semibold text-slate-700 dark:text-slate-200 hover:text-electric-blue dark:hover:text-cyber-blue transition-colors"
            >
              Log In
            </Link>
            <Link
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white dark:bg-[#020617] border-b border-slate-200 dark:border-white/10 p-6 absolute w-full backdrop-blur-xl">
          <div className="flex flex-col gap-4">
            ...
            <Link
              to="/admin"
              className="flex items-center justify-between text-lg font-bold text-electric-blue dark:text-cyber-blue"
            >
