...
export const AIIntelligenceSection = () => {
  return (
    <section
      id="ai-intelligence"
      className="py-16 md:py-24 lg:py-32 relative z-10 border-t border-slate-200/50 dark:border-white/5"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">
            Stop guessing. Our proprietary AI engine forecasts sales, predicts
            peak hours, and identifies menu optimization opportunities before
            they happen.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {landingData.aiFeatures.map((item, idx) => {
            const Icon = item.icon;
            return (
              <div
                key={idx}
                className="glass-panel p-8 rounded-[24px] hover:shadow-[0_0_40px_rgba(59,130,246,0.15)] transition-all duration-300 group"
              >
